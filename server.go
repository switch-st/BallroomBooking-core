...
// TODO 加入版本
// git rev-list --all --count  =>> 版本号
// git describe --tags --always --dirty --match hin2n_v*  =>> 版本名
// go build -ldflags "-X main.build=`git rev-parse HEAD`" main.go 向代码添加版本号
// TODO golang Makefile
// TODO daemon
func main() {
